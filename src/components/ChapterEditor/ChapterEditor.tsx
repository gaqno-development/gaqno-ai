      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleGenerateContent} disabled={isGenerating} variant="outline" size="sm">
              {isGenerating ? (
                <>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="chapter-title" value={title} onChange={(e) => handleTitleChange(e.target.value)} />
          </div>
          <div className="space-y-2">
